...
*/
void get_array_manually(int* array, size_t size, int low, int high);
...
* @param high - верхняя граница массива
*/
void get_array_randomly(int* array, size_t size, int low, int high);
 ...
 */
int task1(const int* array, size_t size);
 ...
 */
int task2(const int* array, size_t size);
 ...
 */
size_t task3(const int* array, size_t size);
 ...
 * @param high -верхняя граница массива
 */
void check_range(int low, int high);
